...
func (m *Manager) CompleteTransaction(id common.QueuedTxID, password string) (hash gethcommon.Hash, err error) {
	...
	hash, err = m.completeTransaction(config, tx, account, password)
...
func (m *Manager) completeTransaction(config *params.NodeConfig, queuedTx *common.QueuedTx, selectedAccount *common.SelectedExtKey, password string) (hash gethcommon.Hash, err error) {
